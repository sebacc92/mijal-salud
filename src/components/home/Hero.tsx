...
const taglines = [
  ...
  `Más de ${new Date().getFullYear() - 2005} años cuidando la salud`,
];
          ...
          >
            ...
            <div>
              <p class="text-white/50 text-xs font-body uppercase tracking-wide mb-0.5">
                Central de emergencias exclusiva para convenios activos
              </p>
              <a
                href={TELEFONO_HREF}
                class="text-white font-display font-bold text-xl sm:text-2xl hover:text-verde-400 transition-colors"
              >
                {TELEFONO_EMERGENCIAS}
              </a>
              <p class="text-white/40 text-xs font-body mt-0.5">{TELEFONO_NOTA}</p>
            </div>
          </div>
        </div>
      </div>
