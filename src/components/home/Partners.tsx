  ...
  return (
    <section class="py-16 bg-white">
      <div class="container mx-auto px-6 lg:px-12">
        ...
        {/* Grid de Partners */}
        <div class="flex flex-wrap items-center justify-center gap-x-12 gap-y-10 max-w-6xl mx-auto">
          {/* Assist Card */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 100 100" class="h-16 w-16" aria-label="Assist Card">
          ...
          {/* Reconquista */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 200 100" class="h-16 w-36" aria-label="Reconquista">
          ...
          {/* OSSEG */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 180 100" class="h-16 w-32" aria-label="OSSEG">
          ...
          {/* OMINT ART */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 200 100" class="h-16 w-32" aria-label="OMINT ART">
          ...
          {/* OSPIC */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 180 100" class="h-16 w-32" aria-label="OSPIC">
          ...
          {/* Ospical */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 180 100" class="h-16 w-32" aria-label="Ospical">
              <g transform="translate(35, 50)">
          ...
          {/* OSEIV */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 220 100" class="h-16 w-36" aria-label="OSEIV">
          ...
          {/* PAMI */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 180 100" class="h-16 w-32" aria-label="PAMI">
              <g transform="translate(35, 50)">
          ...
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 240 100" class="h-16 w-40" aria-label="Centro Medico Pueyrredon">
          ...
          {/* Santa Catalina */}
          <div class="flex items-center justify-center transition-all duration-300 hover:scale-105 hover:opacity-90 grayscale hover:grayscale-0">
            <svg viewBox="0 0 240 100" class="h-16 w-40" aria-label="Santa Catalina">
              <g transform="translate(35, 50)">
