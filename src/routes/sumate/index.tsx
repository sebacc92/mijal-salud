...
const beneficios = [
  ...
  },
  {
    ...
    desc: `Más de ${new Date().getFullYear() - 2005} años de trayectoria con un equipo humano excepcional.`,
  },
];
      ...
      <section class="bg-navy-900 relative overflow-hidden py-20">
        ...
        <div class="relative container mx-auto px-6 lg:px-12 text-center">
          ...
          <p class="text-white/70 font-body text-body-lg max-w-2xl mx-auto">
            Trabajá con más de {new Date().getFullYear() - 2005} años de experiencia en el sector. Hacé la
  ...
  meta: [
    {
      name: "description",
      content:
        `Buscamos médicos, enfermeros, paramédicos y personal administrativo. Trabajá con más de ${new Date().getFullYear() - 2005} años de experiencia en salud domiciliaria.`,
    },
  ],
};
